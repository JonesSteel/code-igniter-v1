        ...
        <div class="col-md-12">
            <div class="well well-sm">
            	...
            	<fieldset>
            		...
            		<legend class="text-center header">MENU</legend>

				<div class="form-group">
				    <div class="col-md-5">						
							<a href="<?php //echo base_url(); ?>index.php/Controlcajas/indexExpediente" class="badge badge-primary"><h2>Control de Ubicaci&oacute;n de Expediente</h2></a>						
					</div>
				</div>

				<div class="form-group">
				    <div class="col-md-5">				        
				        	<a href="<?php //echo base_url(); ?>index.php/Controlcajas/indexCaja" class="badge badge-primary"><h2>Control de Ubicaci&oacute;n de Caja</h2></a>		
					</div>
				</div>

				<div class="form-group">
					<div class="col-md-5">				        
				        	<a href="<?php //echo base_url(); ?>index.php/Controlcajas/indexPlacasxCaja" class="badge badge-primary"><h2>Ver las placas de una caja</h2></a>			
